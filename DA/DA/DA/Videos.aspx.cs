...
namespace DA
{
    public partial class Videos : System.Web.UI.Page
    {
        ...
        /// </summary>
        int BrokerPort = 8883;
        mqtt.subscribe ss = new mqtt.subscribe();
        ...
        public void Subscribeweb()
        {
            ...
            var client = new MqttClient(IotEndpoint, BrokerPort, true, caCert, clientCert, MqttSslProtocols.TLSv1_2,null,null);
            ...
            //this.Connect(clientId, null, null, false, MqttMsgConnect.QOS_LEVEL_AT_MOST_ONCE, false, null, null, true, MqttMsgConnect.KEEP_ALIVE_PERIOD_DEFAULT);
            ...
            while (true)
            {
                ...
                if (likecount < 8 && flag=="1")
                {
                    ...
                    Response.Redirect("Videocola.aspx");
                }
