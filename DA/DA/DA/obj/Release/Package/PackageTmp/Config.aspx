    ...
    <form id="form1" runat="server">
        <div align="center">
            ...
            <table>
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lblthata" Text="Theta" runat="server" CssClass="labeltext"></asp:Label></td>
                    <td>
            ...
            <table>
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="Label2" Text="Theta Level" runat="server" CssClass="labeltext"></asp:Label></td>
                    <td>
